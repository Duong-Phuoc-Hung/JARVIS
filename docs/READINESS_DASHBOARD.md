...
| **D-06** | `jarvis/comms/telegram.py` | Telegram transport fail-closed & user whitelist defense | `tests/test_adversarial_beta_m1_comms_failclosed.py` | `DONE (scope hạn chế)` (1 live cycle 2026-09-12) |
